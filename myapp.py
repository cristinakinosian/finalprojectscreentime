...
with st.expander("rainbow:[Click here if you have ever wondered why it is so difficult to implement healthier routines]", expanded=False, key=None, icon=None, width="stretch", on_change="ignore", args=None, kwargs=None):
